...
# Interpret what this means below

# This means that there is a positive relationship between the change in life 
# expectancy and the change in HALE. More specifically, As the change in life 
# expectancy increases the change in Health Adjusted Life Expectancy increases
# as well. This makes sense because as individuals live longer, there are many
# more years in which the invdividuals can live in a healthy state.
